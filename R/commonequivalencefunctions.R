...
## From here on function are from the T-Test module
...
#     out <- jaspTTests::.posterior_t(delta, t = t, n1 = n1, n2 = n2, independentSamples = ! paired && !is.null(n2),
...
#     }
#   } else if (options[["informativeStandardizedEffectSize"]] == "normal") {
#     out <- jaspTTests::.posterior_normal(delta, t = t, n1 = n1, n2 = n2, independentSamples = ! paired && !is.null(n2),
#                              prior.mean = options[["informativeNormalMean"]],
#                              prior.variance = options[["informativeNormalStd"]]^2)
#
#     if (oneSided == "right") {
